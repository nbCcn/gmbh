 ...
 */
@Entity
@Table(name = "sys_order_auditing")
@NamedEntityGraph(name = "orderAuditing.all",
        attributeNodes = {
                @NamedAttributeNode("orderTemplatesAuditingList"),
...
public class OrderAuditing {
    ...
    @JoinColumn(name = "temp_type_id",referencedColumnName = "id",foreignKey = @ForeignKey(name = "none",value = ConstraintMode.NO_CONSTRAINT),insertable = false,updatable = false)
    ...
    public List<OrderTemplatesAuditing> getOrderTemplatesAuditingList() {
        return orderTemplatesAuditingList;
    }

    public void setOrderTemplatesAuditingList(List<OrderTemplatesAuditing> orderTemplatesAuditingList) {
        this.orderTemplatesAuditingList = orderTemplatesAuditingList;
    }
}
